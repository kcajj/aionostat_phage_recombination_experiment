...
if __name__ == "__main__":
    ...
    for population in populations:
        for timepoint in timepoints:
            bam_file_path = f'chimeric_reads/data/{population}/{population}_{timepoint}.bam'
            ...
            df.to_csv(f'chimeric_reads/longest_matching_reads/{population}/{population}_{timepoint}.csv')